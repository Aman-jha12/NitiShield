...
app.post("/upload", optionalAuth, upload.fields([
...
app.post("/appeal", optionalAuth, async (req, res) => {
    try {
        const aiResp = await axios.post(`${AI_URL}/appeal`, req.body, {
            timeout: 120_000,
        });
        const letter = aiResp.data.appeal_letter;
